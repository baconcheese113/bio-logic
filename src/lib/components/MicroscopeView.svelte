<script lang="ts">
  ...
  const stains: { value: StainType; label: string }[] = [
    { value: 'none', label: 'No Stain' },
    { value: 'gram', label: 'Gram Stain' },
    { value: 'acid-fast', label: 'Acid-Fast Stain' },
    { value: 'capsule', label: 'Capsule Stain' },
    { value: 'spore', label: 'Spore Stain' },
  ];
